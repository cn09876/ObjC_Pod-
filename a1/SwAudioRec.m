                               ...
                               AudioBufferList *ioData)
{
    ...
    UInt32 pcm_len=buffList->mBuffers[0].mDataByteSize;
    short *data = (short *)buffList->mBuffers[0].mData;
    
    
    NSLog(@"RecordCallback called ,sound.track.count=%d,first=%d",pcm_len, data[0]);
